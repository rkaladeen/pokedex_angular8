...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.getPokemonDB = function (group) {
        var _this = this;
        this.group = group;
        var pokemonDB = this._httpService.getPokemonList(group);
        pokemonDB.subscribe(function (data) {
            _this.db_pokemon = data;
            console.log(data);
        });
    };
    AppComponent.prototype.getPokemon = function (url) {
        var _this = this;
        var pokemon = this._httpService.getPokemon(url);
        pokemon.subscribe(function (data) {
            _this.pokemon = data;
            console.log(data);
        });
    };
    AppComponent.prototype.moveGroup = function (num) {
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.getPokemonList = function (group) {
        return this._http.get("https://pokeapi.co/api/v2/pokemon/?offset=" + group + "&limit=20");
    };
    HttpService.prototype.getPokemon = function (url) {
...
module.exports = __webpack_require__(/*! C:\OneDrive\CodingDojo\mean_stack\pokedex\src\main.ts */"./src/main.ts");
